...
public class EntityOcelot extends EntityTameable
{
    ...
    public EntityOcelot(World par1World)
    {
        ...
        tasks.addTask(3, aiTempt = new EntityAITempt(this, 0.18F, mod_CookedFood.fishRaw.shiftedIndex, true));
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (!isTamed())
        {
            if (aiTempt.func_48270_h() && itemstack != null && itemstack.itemID == mod_CookedFood.fishRaw.shiftedIndex && par1EntityPlayer.getDistanceSqToEntity(this) < 9D)
            {
                itemstack.stackSize--;
    ...
    {
        return par1ItemStack != null && par1ItemStack.itemID == mod_CookedFood.fishRaw.shiftedIndex;
    }
