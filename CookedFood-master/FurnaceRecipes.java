...
public class FurnaceRecipes
{
    ...
    private FurnaceRecipes()
    {
        ...
        addSmelting(mod_CookedFood.porkRaw.shiftedIndex, new ItemStack(Item.porkCooked));
        addSmelting(mod_CookedFood.beefRaw.shiftedIndex, new ItemStack(Item.beefCooked));
        addSmelting(mod_CookedFood.chickenRaw.shiftedIndex, new ItemStack(Item.chickenCooked));
        addSmelting(mod_CookedFood.fishRaw.shiftedIndex, new ItemStack(Item.fishCooked));
