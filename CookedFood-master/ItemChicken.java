...
private int isFull;
	...
	public ItemChicken(int par1, int par2, float f, boolean b)
    {
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE)
        {
            ...
            if (par2World.getBlockMaterial(i, j, k) == Material.lava)
            {
                ...
                {
                    return new ItemStack(Item.chickenCooked);
                }

                if (!par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.chickenCooked)))
                {
                    par3EntityPlayer.dropPlayerItem(new ItemStack(Item.chickenCooked, 1, 0));
                }
            }
