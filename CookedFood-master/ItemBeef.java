...
private int isFull;
	...
	public ItemBeef(int par1, int par2, float f, boolean b)
    {
	...
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
    {
        ...
        if (movingobjectposition.typeOfHit == EnumMovingObjectType.TILE)
        {
            ...
            if (par2World.getBlockMaterial(i, j, k) == Material.lava)
            {
                ...
                if (!par3EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Item.beefCooked)))
                {
                    par3EntityPlayer.dropPlayerItem(new ItemStack(Item.beefCooked, 1, 0));
                }
            }
