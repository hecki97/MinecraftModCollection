...
public class ContainerWorkbench extends Container
{
    ...
    public boolean canInteractWith(EntityPlayer par1EntityPlayer)
    {
        if (worldObj.getBlockId(posX, posY, posZ) != Block.workbench.blockID)
            ...
            if (worldObj.getBlockId(posX, posY, posZ) != mod_MoBlocks.Crafting2.blockID)
           
            if (worldObj.getBlockId(posX, posY, posZ) != mod_MoBlocks.Crafting3.blockID)
            
            if (worldObj.getBlockId(posX, posY, posZ) != mod_MoBlocks.Crafting4.blockID)
            {
                return false;
            }
